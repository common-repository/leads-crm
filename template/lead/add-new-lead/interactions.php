<div class="zleadscrm_col_12 zleadscrm_row zleadscrm_disabled_padding zleadscrm_lead_fields" style="margin-top: 2rem;">
    <div class="zleadscrm_col_8 zleadscrm_disabled_padding" style="align-self: start;">
        <div class="zleadscrm_tab_content zleadscrm_col_12 zleadscrm_disabled_padding zleadscrm_card_box"
		...
		$lead_interactions = new ZLEADSCRM_BASIC_Core_Lead_Interactions( $edit_lead );
    ...
    <div class="zleadscrm_col_3 zleadscrm_mobile_col zleadscrm_disabled_padding" style="align-self: start;">
        <form method="POST" action="<?php echo admin_url( 'admin-post.php' ); ?>"
            ...
            <input type="hidden" name="redirect_tab" value="interactions"/>
